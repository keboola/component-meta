...
class TestDSLParameterParsing(unittest.TestCase):
    ...
    def _make_query_config(self, fields, limit=500, path=None, since="", until="", parameters=None):
        query_config = MagicMock()
        query_config.limit = limit
        query_config.path = path
        query_config.fields = fields
        query_config.since = since
        query_config.until = until
        query_config.parameters = parameters
        return query_config

    def test_parse_level_parameter(self):
        """Test parsing .level(ad) from DSL syntax"""
        params = self.loader._build_params(self._make_query_config("insights.level(ad)"))
    ...
    def test_parse_action_breakdowns_parameter(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights.action_breakdowns(action_type)"))
    ...
    def test_parse_date_preset_parameter(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights.date_preset(last_3d)"))
    ...
    def test_parse_time_increment_parameter(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights.time_increment(1)"))
    ...
    def test_parse_breakdowns_parameter(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights.breakdowns(age,gender)"))
    ...
    def test_parse_fields_from_curly_braces(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights{ad_id,ad_name,spend,clicks}"))
    ...
    def test_account_id_not_duplicated(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights{account_id,ad_id,spend}"))
    ...
    def test_legacy_metric_and_period_still_work(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights.metric(page_fans).period(day)"))
    ...
    def test_parse_action_attribution_windows_parameter(self):
        ...
        params = self.loader._build_params(
            self._make_query_config("insights.action_attribution_windows(7d_click,1d_view)")
        )
    ...
    def test_parse_action_report_time_parameter(self):
        ...
        params = self.loader._build_params(self._make_query_config("insights.action_report_time(impression)"))
